...
sanitizeHtml.defaults.allowedAttributes.input = ['type', 'disabled', 'checked']

## Additional HTML features
sanitizeHtml.defaults.allowedTags.push 's', 'u', 'tt', 'kbd'
...
allowedClasses = [
  ...
  'fake-checkbox'  # our replacement for disabled checkboxes
  # highlight.js
