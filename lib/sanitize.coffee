...
sanitizeHtml.defaults.allowedAttributes['*'] = [
  ...
  'data-messagepdf'  # generated by embedded PDF files
  'id'  # sanitized below
]
...
sanitizeHtml.defaults.allowedTags.push 's', 'u', 'tt', 'kbd', 'sup', 'sub'
...
sanitizeHtml.defaults.allowedAttributes.use = ["clip-path", "clip-rule", "fill", "fill-opacity", "fill-rule", "filter", "height", "mask", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "transform", "width", "x", "xlink:href", "href", "y"]
...
sanitizeHtml.defaults.transformTags =
  ...
  '*': (tagName, attribs) ->
    ...
    if attribs.id?
      attribs.id = 'MESSAGE_' + attribs.id
    tagName: tagName
    attribs: attribs
